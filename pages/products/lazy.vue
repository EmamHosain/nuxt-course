<script setup>
// when all product pending for fetching data then the loading.. will be show, that is very user friendly
const { data, pending, error, refresh } = await useLazyFetch('https://fakestoreapi.com/products')
    ...
    <div>
        ...
        <div class="container mx-auto p-6">
            ...
            <div v-else-if="pending">
                <h1 class="text-center font-bold text-3xl">Lazy Loading...</h1>
            </div>
            <div v-else>
                <h1 class="text-center font-bold text-3xl">with Lazy loading</h1>
